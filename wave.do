...
add wave -format Logic /testbench/noc1/tx(1)(0)
add wave -format Logic /testbench/noc1/credit_i(1)(0)
add wave -format Literal -radix hexadecimal /testbench/noc1/data_out(1)(0)


add wave -divider {roteador 20 PORTA NORTE}
add wave -format Logic /testbench/noc1/tx(2)(2)
add wave -format Logic /testbench/noc1/credit_i(2)(2)
add wave -format Literal -radix hexadecimal /testbench/noc1/data_out(2)(2)


add wave -divider {roteador 21 PORTA NORTE}
add wave -format Logic /testbench/noc1/tx(5)(2)
add wave -format Logic /testbench/noc1/credit_i(5)(2)
add wave -format Literal -radix hexadecimal /testbench/noc1/data_out(5)(2)

 
add wave -divider {roteador 22 PORTA LOCAL}
add wave -format Logic /testbench/noc1/tx(8)(4)
add wave -format Logic /testbench/noc1/credit_i(8)(4)
add wave -format Literal -radix hexadecimal /testbench/noc1/data_out(8)(4)
